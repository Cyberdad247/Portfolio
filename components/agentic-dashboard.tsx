...
const agentStatus = [
  { id: "A-01", name: "Market Scanner", status: "active" as const, icon: Globe },
  { id: "A-02", name: "Competitor Analyst", status: "processing" as const, icon: Search },
  { id: "A-03", name: "Sentiment Engine", status: "idle" as const, icon: MessageSquare },
  { id: "A-04", name: "Strategy Synthesizer", status: "active" as const, icon: BrainCircuit },
]
