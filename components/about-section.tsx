				...
				<div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
					...
					>
						...
						<p className="mt-6 leading-relaxed text-muted-foreground">
							...
							merging cutting-edge artificial intelligence with human
							creativity. Our mission is clear: to deliver AI-powered marketing
							strategies that are smarter, faster, and designed to drive
							measurable results.
						</p>
