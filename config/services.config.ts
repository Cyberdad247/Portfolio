...
export const services: ServiceConfig[] = [
    {
        ...
        description: "Stand up your first Agentic Growth OS, connect your key channels, and start generating measurable leads with a system that can scale.",
        outcomes: [
        ...
        faqs: [
            {
                ...
                answer: "Most Agentic Launch engagements run 8–12 weeks from kickoff to a stable baseline of experiments and dashboards.",
            },
            {
                question: "What does pricing look like?",
                answer: "Pricing depends on your channel mix and complexity. Most Agentic Launch clients fall in the low-to-mid four-figure monthly range.",
            },
        ],
    },
    {
        slug: "agentic-scale",
        name: "Agentic Scale",
        summary: "Scale winning channels and expand into new ones with system-level visibility.",
        fit: "Growing brands with traction that need more experiments and better attribution.",
        description: "Accelerate your growth by scaling validated channels and systematically testing new ones through the Agentic Nexus fleet.",
        outcomes: [
        ...
        faqs: [
            {
                ...
                answer: "Both. The logic of the Growth OS adapts to your sales cycle, whether it's a 1-day impulse buy or a 6-month enterprise deal.",
            },
        ],
    },
    {
        ...
        summary: "Integrate Agentic Growth OS with RevOps, sales, and multi-region teams.",
        fit: "Mature organizations that need alignment across marketing and revenue teams.",
        description: "Unify your marketing stack, sales CRM, and regional operations into a single Sovereign Intelligence Layer.",
        outcomes: [
        ...
        faqs: [
            {
                ...
                answer: "No. We empower them. We provide the 'Sovereign Engine' that your team uses to execute at 10x speed.",
            },
        ],
    },
];
