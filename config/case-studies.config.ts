...
export const caseStudies: CaseStudyConfig[] = [
    {
        ...
        objective: "Rapid scaling of qualified lead volume via AI-managed organic and paid search sync.",
        time: "6 Months // 2025",
        summary: "Transforming SaaS lead generation through high-velocity AI experiment cycles.",
        results: [
    ...
    },
    {
        ...
        objective: "Modernizing a fragmented marketing stack through a centralized Agentic OS middleware.",
        time: "12 Months // 2024-2025",
        summary: "Universal data synchronization across fragmented marketing ecosystems.",
        results: [
