		...
		return (
			<div className="flex min-h-screen items-center justify-center pt-24 bg-background">
				<div className="text-center">
					<h1 className="text-4xl font-extrabold text-foreground mb-4 italic">
						Protocol Redacted.
					</h1>
					<p className="text-muted-foreground mb-8">
						Service tier identifier invalid or unauthorized {"//"} 404.
					</p>
					<Link
						href="/services"
						className="text-primary font-bold hover:underline underline-offset-4 font-mono uppercase tracking-widest text-xs"
					>
		...
		<main className="relative min-h-screen bg-background pt-40 pb-32 overflow-hidden">
			...
			<div className="relative z-10 mx-auto max-w-6xl px-4 md:px-8">
				...
				>
					<Link
						href="/services"
						className="mb-12 inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground hover:text-primary transition-colors"
					>
				...
				<header className="mb-24">
					...
					>
						<div className="mb-6 inline-flex rounded-full bg-primary/10 px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-primary border border-primary/20">
							Growth OS Tier {"//"}{" "}
							{service.slug.replace("agentic-", "").toUpperCase()}
						</div>
							...
							<div className="grid gap-4 sm:grid-cols-1">
								{service.outcomes.map((outcome) => (
									...
									>
										...
										<p className="text-lg text-foreground/90 leading-snug">
											{outcome}
										</p>
									</motion.div>
								))}
				...
				<div className="mt-32 pt-24 border-t border-border/50 text-center">
					<p className="text-[10px] font-mono uppercase tracking-[0.4em] text-muted-foreground opacity-50 mb-12">
						Sovereign Infrastructure {"//"} Secure Protocol {"//"} Agentic
						Outcomes
					</p>
