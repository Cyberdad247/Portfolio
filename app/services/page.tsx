...
export const metadata: Metadata = {
	title: "Services",
	description:
		"Explore Invisioned Marketing's Agentic Growth OS service tiers for launch, scale, and enterprise growth.",
};
			...
			<div className="relative z-10 mx-auto max-w-6xl">
				<header className="mb-16 text-center">
					<h1 className="text-4xl font-bold tracking-tight text-foreground md:text-6xl">
						Agentic Growth{" "}
						<span className="text-primary italic font-serif">OS</span> Services
					</h1>
					<p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
						Choose the level of Agentic Growth OS that matches your current
						stage. All tiers share the same principles: measurable lead growth,
						experiment velocity, and clear attribution.
					</p>
				</header>
				...
				<div className="mt-20 rounded-3xl border border-border bg-card/30 p-12 backdrop-blur-md text-center">
					...
					<p className="text-muted-foreground mb-8 max-w-xl mx-auto">
						Let's run a free Agentic Audit against your current funnel and
						campaigns to identify the most immediate growth levers.
					</p>
					<Link
						href="/#contact"
