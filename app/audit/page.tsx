...
import { AlertCircle, Globe, Search, Zap } from "lucide-react";
import { useState } from "react";
import { AmbientGlow } from "@/components/ui/ambient-glow";

const glassCard =
	"rounded-2xl border border-border bg-card p-8 backdrop-blur-md relative overflow-hidden transition-all hover:border-primary/30";
			...
			<div className="relative z-10 mx-auto max-w-7xl">
				...
				>
					...
					<p className="text-muted-foreground max-w-2xl mx-auto text-lg">
						Benchmark your digital visibility across traditional search engines
						and generative AI citation engines.
					</p>
				</motion.div>
				...
				<div className="max-w-3xl mx-auto mb-16">
					...
					{auditResult && !isScanning && (
						<div className="mt-4 p-4 rounded-lg bg-green-500/10 border border-green-500/20 text-green-400 text-sm flex items-center gap-2">
							...
							Status: {auditResult.status} | Target: {auditResult.target} |
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					<div className={glassCard}>
						...
						<p className="text-muted-foreground mb-6">
							Deep scan of metadata, LCP, CLS, and contextual backlink weight.
						</p>
					...
					<div className={glassCard}>
						...
						<p className="text-muted-foreground mb-6">
							Probability modeling for AI answer citations (GPT-4, Claude,
							Gemini).
						</p>
						<div className="space-y-4">
							<div className="flex justify-between text-sm">
