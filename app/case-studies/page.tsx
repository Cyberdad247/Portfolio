...
export const metadata: Metadata = {
    ...
    description: "Explore performance data and real-world results from the Invisioned Agentic Growth OS across various industries.",
};
            ...
            <div className="relative z-10 mx-auto max-w-6xl">
                <header className="mb-20">
                    ...
                    <p className="mt-8 max-w-2xl text-xl text-muted-foreground leading-relaxed">
                        Performance reports and real-world results from our AI-powered marketing OS. Confidentiality is paramount; specific brand names are redacted unless explicitly authorized.
                    </p>
                </header>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    {caseStudies.map((cs) => (
                        <div key={cs.slug} className="group relative rounded-3xl border border-border bg-card/40 p-12 backdrop-blur-xl transition-all hover:border-primary/50">
                            ...
                            <h2 className="text-3xl font-bold text-foreground mb-4">{cs.title.split("//")[0]}</h2>
                            <p className="text-4xl font-mono font-bold text-primary mb-8">{cs.impact}</p>
                            <Link
                ...
                <div className="mt-20 flex justify-center">
                    <Link href="/" className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
