import { ArrowLeft, CheckCircle2, Clock, TrendingUp, Zap } from "lucide-react";
...
export const metadata: Metadata = {
	...
	description:
		"Detailed performance analysis and real-world results from the Invisioned AI-powered marketing OS.",
};
			...
			<div className="mx-auto max-w-7xl">
				...
				<div className="mb-24 grid gap-8 md:grid-cols-3">
					...
					<div className="rounded-3xl border border-border bg-card/30 p-8 backdrop-blur-sm">
						...
						<p className="text-3xl font-bold text-foreground underline decoration-primary decoration-4 underline-offset-8">
							OPTIMIZED
						</p>
					</div>
				</div>
				...
				<div className="mb-24 grid gap-16 lg:grid-cols-2">
					...
					<div className="relative aspect-video overflow-hidden rounded-3xl border border-border bg-muted/20">
						...
						<div className="absolute inset-0 flex items-center justify-center">
							<span className="font-mono text-xs font-bold uppercase tracking-[0.3em] text-muted-foreground/40">
								DATA_VIZ_ACTIVE
							</span>
						</div>
					</div>
				...
				<section className="mb-24">
					<header className="mb-12">
						...
						<p className="text-muted-foreground">
							Visualization of the agentic mesh operating within this
							environment.
						</p>
					</header>
				...
				<div className="rounded-[2rem] bg-foreground p-12 text-background md:p-20 text-center">
					...
					<p className="mx-auto mb-10 max-w-xl text-lg text-background/70">
						Deploy the Invisioned Agentic Growth OS to your ecosystem and
						witness the leap in performance.
					</p>
